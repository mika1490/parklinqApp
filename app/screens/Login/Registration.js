    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity 
          ...
          <Text style={{ color: '#39c1ef', fontSize:18 }}>Sign up with Google</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={styles.socialLogin}>
          <Text style={{ color: '#39c1ef', fontSize: 18 }}>Sign up with Facebook</Text>
        </TouchableOpacity>
        <Text style={styles.textRegister}> ───────  Or  ───────</Text>
          ...
          <TouchableOpacity style={styles.button}>
            <Text style={{ color: '#39c1ef', fontSize: 18 }}>Sign up with Email</Text>
          </TouchableOpacity>
